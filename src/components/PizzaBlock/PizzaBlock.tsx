...
import { getCartItemSelectorById, setAddItem, TCartItem } from '../../redux/slices/cartSlices';
...
const PizzaBlock: React.FC<PizzaBlockProps> = ({ id, title, price, imageUrl, types, sizes }) => {
  ...
  //const cartItem = useSelector((state) => state.cartSlices.items.find((obj) => obj.id === id));
