...
import { getCartSelector, setClearItems } from '../redux/slices/cartSlices';
...
const Cart: React.FC = () => {
  ...
  // const dispatch = useDispatch();
  const sumCart = items.reduce((sum: number, obj: any) => sum + obj.count, 0);
